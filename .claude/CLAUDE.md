...
- Экраны:
  ...
  - ответ показывается сразу, без «показать по клику»: скрывать его имеет смысл только в симуляторе экзамена, где это часть упражнения, а на странице билета мешает;
